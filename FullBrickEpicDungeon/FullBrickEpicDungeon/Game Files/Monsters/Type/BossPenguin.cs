...
class BossPenguin : AImonster
{
    ...
    public BossPenguin(Level level) : base(0, level, "BossPenguin", 2000)
    {
        ...
        //Load the animations
        LoadAnimation("Assets/Sprites/Enemies/PenguinBossSide@4", "sideWalk", true, 0.2f);
        LoadAnimation("Assets/Sprites/Enemies/PenguinBossFront@4", "sideFront", true, 0.2f);
        LoadAnimation("Assets/Sprites/Enemies/PenguinBossBack@4", "sideBack", true, 0.2f);
        LoadAnimation("Assets/Sprites/Enemies/PenguinBossSlideUp@4", "slideUp", true, 0.2f);
        LoadAnimation("Assets/Sprites/Enemies/PenguinBossSlideSide@4", "slideSide", true, 0.2f);
        LoadAnimation("Assets/Sprites/Enemies/PenguinBossSlideDown@4", "slideDown", true, 0.2f);
