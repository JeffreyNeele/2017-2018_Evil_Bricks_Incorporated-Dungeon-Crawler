...
{
    public ShadowHunter(int playerNumber, bool keyboardControlled) : base(playerNumber, keyboardControlled, ClassType.ShadowHunter, "Sprites/Lightbringer/lightbringer_default", "Lightbringer")
    {
